 ...
 * it's successfully migrated some data, but has more to do on the subsequent ajax request;
 * EE_Data_Migration_Manager::status_completed to indicate it successfully migrate some data, and has nothing left to
 * do; or EE_Data_Migration_Manager::status_fatal_error to indicate an error occurred which means the ajax script
 * should probably stop executing.
 */
