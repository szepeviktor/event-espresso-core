...
class EE_Dependency_Map
{
    ...
    protected function _register_core_dependencies()
    {
        $this->_dependency_map = array(
            ...
            'EventEspresso\core\domain\entities\editor\blocks\widgets\EventsList' => array(
                'EventEspresso\core\domain\entities\editor\blocks\CoreBlocksAssetManager' => self::load_from_cache,
                'EventEspresso\core\domain\entities\shortcodes\EspressoEvents'            => self::load_from_cache,
            ),
        );
    }
